...
# this file provides a python wrapper for trec_dl

# implements the trec_eval class
...
class Trec(Metric):
	...
	def write_ranking_trec(scores, q_ids, results_file_path):
		...
		results_file.close()
	def write_scores(self, scores, qids, path):
		self.write_ranking_trec(scores, qids, f'{path}.trec')
